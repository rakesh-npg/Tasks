  ...
  export default{
    ...
    methods: {
        async validate() {
            ...
            await axios.post("http://127.0.0.1:3333/emp/create", tempdata, {
                headers: {}
            }).then((response) => {
        ...
        async edit_reqest() {
            ...
            await Vue.axios.put("http://127.0.0.1:3333/emp/update", tempData, {
                headers: {}
            }).then(() => {
                this.readData();
            });
        ...
        async delete_data(item) {
            ...
            await Vue.axios.put("http://127.0.0.1:3333/emp/delete", tempData, {
                headers: {}
            }).then(() => {
                this.readData();
            });
